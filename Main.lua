...
local FontAlias = {
	...
	-- Roboto variants
	Rbt = "Roboto",
	RbtC = "RobotoCondensed",
	RbtCondensed = "RobotoCondensed",
	RbtM = "RobotoMono",
	RbtMono = "RobotoMono",
	Mono = "RobotoMono",
...
function GUI:AddSettingsFrame(info)
	...
	TabHeader.Size = UDim2.new(1, -10, 0, 30)
	TabHeader.BackgroundTransparency = 1
	TabHeader.Position = UDim2.new(0, 5, 0, 5)
	...
	function FrameAPI:AddTab(name)
		...
		TabButton.Font = GUI.DefaultTab.Font
		TabButton.TextSize = GUI.DefaultTab.TextSize
		...
		function TabAPI:CreateTitle(info)
			...
			Title.BackgroundTransparency = info.BgTransparent or GUI.DefaultTitle.BgTransparent
			...
			Label.TextSize = info.TextSize or GUI.DefaultTitle.TextSize
			Label.Font = ResolveFont(info.Font or GUI.DefaultTitle.Font)

			--------------------------------------------------------------------
			-- ALIGN
			--------------------------------------------------------------------
			local align = info.Align or GUI.DefaultTitle.Align
			local alignMapX = {
